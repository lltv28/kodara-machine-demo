...
The proof section uses the headline “Results From Other Health & Wellness Experts We've Worked With” and leads with supported client desires: more reach, less dependence on one-to-one delivery, more time, and a business that can work beyond the expert's calendar. Its unified sequence remains Sandra's featured quote with five decorative brand stars, three video stories, then concise result summaries for Dr. Vora and Ashley in the same grid. Sandra and Dr. Mike use matching portrait cards in the first desktop row, while Leanne's widescreen story spans the row beneath them; Dr. Vora and Ashley follow as a paired result row on desktop, while Ashley appears before Dr. Vora on mobile. All five cards stack on mobile. Sandra and Leanne do not repeat as separate result-summary cards because their stories already appear in video. Portrait cards use a taller 4:3 desktop media stage while preserving each video's native portrait proportions inside it. Each result summary includes a circular client identity. Use a real portrait only when the user has identified and approved the client asset; otherwise use an initial avatar until the correct headshot is supplied. Dr. Vora and Ashley use the user-approved public portraits, mirrored for the card composition; Ashley's public card omits her last name. Do not infer testimonial identities from search-result rank or visual resemblance. Sandra's supplied transcript for Wistia testimonial `6oj2gj3wqt` supports her previous inability to find a consistently profitable advertising return, her 3–6 ROAS, on-track-to-double revenue, fewer-calls, and improved-consistency statements; its 3:4 portrait frame must remain fully visible rather than be cropped into widescreen. Dr. Mike's Wistia testimonial `b3djcgwuvz` uses its native 9:16 portrait frame and identifies his business as Power-Up Sports Psychology. His local source transcript is recorded in `docs/proof-sources/dr-mike-testimonial.md`; his public card uses the user-approved framing that he failed with four competitors before launching in 30 days with Kodara. His `$100,000 per month` statement is a future goal, not an achieved result. Leanne's approved public role is “Neuroscience educator.” The stars are decorative and must not be described as a customer rating without verified evidence. Result summaries use only supplied outcomes and exactly two supporting facts. Video cards label the supported outcome as “What changed,” and the adjacent disclaimer states that individual outcomes vary.
